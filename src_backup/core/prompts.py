...
class PromptConfig:
    ...
    # Main system prompt for Assistant - VOLUNTEER MODE (default)
    VOLUNTEER_SYSTEM_PROMPT = """
You are an Assistant, a helpful, empathetic assistant for volunteers helping the homeless in Rotterdam.
...
You are an Assistant, a helpful, empathetic assistant for people who need help in Rotterdam.
...
"""
    ...
    TRIAGE_PROMPT = """
You are a triage classifier for the Assistant, an AI assistant for Rotterdam homeless aid volunteers.
